...
## 6. 개발 능력보다 더 중요한 문제 해결 능력

- 개발자에게 가장 필요한 역량이 코딩 실력이라고 생각하기 쉽지만, 진짜 중요한 것은 **문제를 발견하고 해결하는 역량**이다.
- 요즘 기업들은 단순한 기능 구현자가 아니라, **팀원들과 협력하여 문제를 정의하고 해결책을 만드는 개발자**를 원한다.
- 문제 해결 능력이 높은 개발자는 **'어떤 일을 마주하더라도 결국 해결해내는 사람'**이라는 신뢰를 준다.
- 이러한 역량은 아래와 같은 질문들을 통해 드러낼 수 있다.
  - 팀이 직면한 진짜 문제는 무엇인가?
  - 문제의 크기는 어느 정도이고, 얼마나 긴 시간을 가지고 풀어야 하는가?
  - 이 문제가 우리 회사에 얼마나 중요한가?
  - 문제를 해결하려면 각 팀원에게 어떤 전문성이 필요한가?
  - 문제를 해결했을 때 비즈니스에 어떤 영향을 미치는가?

## 7. 이력서 대신 네트워킹으로 승부하기

### 7.1. 링크드인 프로필 만들기

- 채용 담당자가 나를 쉽게 찾을 수 있도록, **매력적인 프로필을 미리 만들어 두는 것**이 중요하다. 아래 요소들을 충실히 채워야 한다.
  - **기술 스택 정리**
  - **선호 개발 분야 강조**
  - **검색 가능한 키워드 활용**
  - **구직 상태 공개**
...
- 기술 블로그는 **지식을 공유하는 아카이브이자, 배운 내용을 정리하는 메모장** 같은 역할을 한다. 누군가를 설득하기 위한 글이 아니므로 어렵게 쓸 필요가 없다.
- 아래 방법을 통해 쉽게 글을 쓸 수 있다.
  - 주제와 관련된 에피소드 3개 떠올리기
  - 내 글을 읽을 독자 설정하기
  - **센터 문장 만들기**: 이 글에서 독자가 꼭 기억해야 할 핵심 문장을 작성한다.
  - 영역별 센터 문장 정하기: 육하원칙에 따라 글의 목적을 구체화한다.
  - 초안 완성 후 동료에게 검토 요청하기

### 7.3. 기술 발표

- 기술 발표 주제는 크게 **기술 문제 해결 방법 공유**와 **일하는 방식 공유**, 두 가지로 나눌 수 있다.
- 기술을 공유할 때는 **'내가 사용하는 기술이 사용자의 삶을 어떻게 바꾸었는가'**에 초점을 맞추고, 일하는 방식을 공유할 때는 **'이 역할을 잘 수행하기 위해 필요한 역량은 무엇인가'**에 대한 스토리텔링을 준비하는 것이 좋다.
- 발표 주제를 찾기 어렵다면, 아래 질문들을 통해 자신의 경험을 되돌아볼 수 있다.
  - 최근 1년간 어떤 업무를 가장 중점적으로 했는가?
  - 내가 담당하게 되면서 새롭게 도입하거나 바꾼 방식이 있는가?
  - 해결하고 나서 가장 큰 뿌듯함을 느꼈던 일은 무엇인가?
